...
export const router = createRouter()
	...
	.get(
		...
		async (c) => {
			...
			const data = await getFundingCalls(db, { limit, offset, status, localeId });
	...
	.get(
		...
		async (c) => {
			...
			const data = await getFundingCallSlugs(db, { limit, offset, localeId });
	...
	.get(
		...
		validator("query", GetFundingCallBySlug.QuerySchema),
		async (c) => {
			...
			const data = await getFundingCallBySlug(db, { slug, localeId });
