...
export const router = createRouter()
	...
	.get(
		...
		async (c) => {
			...
			const data = await getDariahProjects(db, { limit, offset, status, localeId });
	...
	.get(
		...
		async (c) => {
			...
			const data = await getDariahProjectSlugs(db, { limit, offset, localeId });
	...
	.get(
		...
		validator("query", GetDariahProjectBySlug.QuerySchema),
		async (c) => {
			...
			const data = await getDariahProjectBySlug(db, { slug, localeId });
