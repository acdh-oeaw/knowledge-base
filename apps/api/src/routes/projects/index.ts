...
export const router = createRouter()
	...
	.get(
		...
		async (c) => {
			...
			const data = await getProjects(db, { limit, offset, status, localeId });
	...
	.get(
		...
		async (c) => {
			...
			const data = await getProjectSlugs(db, { limit, offset, localeId });
	...
	.get(
		...
		validator("query", GetProjectBySlug.QuerySchema),
		async (c) => {
			...
			const data = await getProjectBySlug(db, { slug, localeId });
