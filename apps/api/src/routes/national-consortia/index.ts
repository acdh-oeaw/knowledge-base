...
export const router = createRouter()
	...
	.get(
		...
		async (c) => {
			...
			const data = await getNationalConsortia(db, { limit, offset, localeId });
	...
	.get(
		...
		async (c) => {
			...
			const data = await getNationalConsortiumSlugs(db, { limit, offset, localeId });
	...
	.get(
		...
		validator("query", GetNationalConsortiumBySlug.QuerySchema),
		async (c) => {
			...
			const data = await getNationalConsortiumBySlug(db, { slug, localeId });
