...
export const router = createRouter()
	...
	.get(
		...
		async (c) => {
			...
			const data = await getWorkingGroups(db, { limit, offset, status, localeId });
	...
	.get(
		...
		async (c) => {
			...
			const data = await getWorkingGroupSlugs(db, { limit, offset, localeId });
	...
	.get(
		...
		validator("query", GetWorkingGroupBySlug.QuerySchema),
		async (c) => {
			...
			const data = await getWorkingGroupBySlug(db, { slug, localeId });
