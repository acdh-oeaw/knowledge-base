...
export const router = createRouter()
	...
	.get(
		...
		async (c) => {
			...
			const data = await getSpotlightArticles(db, { limit, offset, localeId });
	...
	.get(
		...
		async (c) => {
			...
			const data = await getSpotlightArticleSlugs(db, { limit, offset, localeId });
	...
	.get(
		...
		validator("query", GetSpotlightArticleBySlug.QuerySchema),
		async (c) => {
			...
			const data = await getSpotlightArticleBySlug(db, { slug, localeId });
