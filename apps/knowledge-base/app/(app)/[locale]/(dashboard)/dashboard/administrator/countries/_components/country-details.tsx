  ...
  return (
    <Fragment>
      ...
      <div className="flex items-center justify-between">
        <VersionSelector
          draftHref={`/dashboard/administrator/countries/${country.entityVersion.slug.value}/details`}
          hasDraft={hasDraft}
          isPublished={isPublished}
          publishedHref={`/dashboard/administrator/countries/${country.entityVersion.slug.value}/details?version=published`}
        ...
        <div className="flex items-center gap-x-4">
          <EntityLifecycleBar
            ...
            editHref={`/dashboard/administrator/countries/${country.entityVersion.slug.value}/edit`}
            hasDraft={hasDraft}
            isPublished={isPublished}
      ...
      <DescriptionList>
        ...
        <DescriptionDetails>{country.entityVersion.slug.value}</DescriptionDetails>
              ...
              {nationalConsortia.map((consortium) => (
                <RelationStatement
                  ...
                  source={
                    <Fragment>
                      {consortium.unitName}
                      {consortium.unitIsLocaleFallback ? <LocaleFallbackMark /> : null}
                    </Fragment>
                  }
                ...
                <RelationStatement
                  ...
                  source={
                    <Fragment>
                      ...
                      {institution.institutionIsLocaleFallback ? <LocaleFallbackMark /> : null}
                    </Fragment>
                  }
                  sourceHref={getOrganisationalUnitDetailHref(
