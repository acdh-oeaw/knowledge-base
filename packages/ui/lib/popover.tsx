...
export function PopoverContent(props: Readonly<PopoverContentProps>): ReactNode {
	...
	return (
		<PopoverPrimitive
			className={cx(
				"group/popover origin-(--trigger-anchor-point) rounded-(--popover-radius) border border-fg/10 bg-overlay text-overlay-fg shadow-xs outline-hidden transition-transform [--gutter:--spacing(6)] [--popover-radius:var(--radius-xl)] max-inline-xs min-inline-(--trigger-width) sm:text-sm dark:backdrop-saturate-200 **:[[role=dialog]]:[--gutter:--spacing(4)]",
