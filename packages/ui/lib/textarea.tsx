	...
	return (
		<span className="relative block inline-full" data-slot="control">
			<AriaTextArea
				...
				className={cx(
					twJoin([
						"relative block field-sizing-content appearance-none rounded-lg px-[calc(--spacing(3.5)-1px)] py-[calc(--spacing(2.5)-1px)] inline-full min-block-16 sm:px-[calc(--spacing(3)-1px)] sm:py-[calc(--spacing(1.5)-1px)]",
						"text-base/6 text-fg placeholder:text-muted-fg sm:text-sm/6",
						"border border-input hover:border-muted-fg/30",
						"focus:border-ring/70 focus:bg-primary-subtle/5 focus:ring-3 focus:ring-ring/20 focus:outline-hidden",
