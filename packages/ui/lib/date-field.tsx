		...
		<span className="relative block inline-fit" data-slot="control">
			<DateInputPrimitive
				className={cx(
					...
					"focus-within:border-ring/70 focus-within:bg-primary-subtle/5 focus-within:ring-3 focus-within:ring-ring/20 focus-within:outline-hidden focus-within:hover:border-ring/80",
			...
			>
				{(segment) => (
					<DateSegment
						className={twJoin(
							"inline shrink-0 rounded-sm px-1.5 tracking-wider text-fg caret-transparent outline-0 forced-color-adjust-none data-placeholder:not-data-focused:text-muted-fg sm:p-0.5 sm:py-0.5 sm:text-sm forced-colors:text-[ButtonText] type-literal:px-0",
